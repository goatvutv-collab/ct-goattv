...
def carregar_db():
    ...
    try:
        ...
        print("⚠️ Alerta: Erro de leitura ou JSON corrompido. Iniciando base vazia.")
        return {}
    except:
        return {}
